...
public class Utils {
    ...
    public static final String AYUMILOVE = "AYUMILOVE";
    public static final String RAID_CODEX = "Raid-Codex";
    public static final String ALUCARE = "ALUCARE";
    ...
    public static final String MASTERY_URL = "https://files.ayumilove.net/games/raid_shadow_legends/mastery/%s.jpg";
