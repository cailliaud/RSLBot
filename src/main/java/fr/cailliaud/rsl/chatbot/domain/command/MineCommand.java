...
public class MineCommand implements ICommandAnswer {
  ...
  private static final String GEMME_INFO =
      "Coût : %s gems\nProd : 1 gem/%s\nCapacité: %s\nTemps complet : %s";
  ...
  public void publishAnswer(MessageReceivedEvent event, Object... args) {
    ...
    msgEmbedded =
        new EmbedBuilder()
            ...
            .setAuthor(
                CAILLIAUD,
                "https://github.com/cailliaud",
                "https://cdn.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_197,h_192/https://www.alucare.fr/wp-content/uploads/2020/01/image-de-la-mine.jpg")
            ...
            .addField(
                "Est-ce rentable ?",
                "Oui : si vous comptez jouer longtemps au jeu ( plus de 3 mois pour rentabiliser)\nNon : si vous jouez momentanément (utilisez vos gemmes dans la boutique).",
                false)
            .addField(
                ALUCARE,
                "Lien vers Alucare : https://www.alucare.fr/wiki/guide-raid-shadow-legend/la-mine-de-gemmes-sur-raid-shadow-legend/",
                false)
            .addField(
                WIKI_FANDOM,
                "Lien vers wiki : https://raid-shadow-legends.fandom.com/wiki/Mine",
                false)
            .setImage(
                "https://cdn.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_1365/https://www.alucare.fr/wp-content/uploads/2020/01/Mine-de-gemmes.jpg")
